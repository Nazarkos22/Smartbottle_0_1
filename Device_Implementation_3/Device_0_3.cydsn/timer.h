...
/* CSD timers */
#define CSD_APP_CSD_START_SCAN_TIMEOUT_TMR                  (0u)
#define CSD_APP_CSD_START_SCAN_TIMEOUT_TMR_PERIOD           (400u)    
#define CSD_APP_CSD_CHECK_FINISH_SCAN_TIMEOUT_TMR           (1u)
#define CSD_APP_CSD_CHECK_FINISH_SCAN_TIMEOUT_TMR_PERIOD    (100u)
#define CSD_APP_CSD_FINISH_SCAN_TIMEOUT_TMR                 (2u)
#define CSD_APP_CSD_FINISH_SCAN_TIMEOUT_TMR_PERIOD          (100u)
#define CSD_APP_CSD_CREATE_RAW_DATA_TIMEOUT_TMR             (3u)
#define CSD_APP_CSD_CREATE_RAW_DATA_TIMEOUT_TMR_PERIOD      (100u)
#define CSD_APP_CSD_MAKE_DIFF_TIMEOUT_TMR                   (4u)
#define CSD_APP_CSD_MAKE_DIFF_TIMEOUT_TMR_PERIOD            (100u)
#define CSD_APP_CSD_COUNT_LEVEL_TIMEOUT_TMR                 (5u)
#define CSD_APP_CSD_COUNT_LEVEL_TIMEOUT_TMR_PERIOD          (100u) 
#define CSD_APP_CSD_CLEAN_RAWS_TIMEOUT_TMR                  (6u)
#define CSD_APP_CSD_CLEAN_RAWS_TIMEOUT_TMR_PERIOD           (100u)
